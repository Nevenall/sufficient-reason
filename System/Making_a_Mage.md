...
_Describe who your Mage is in five words or so._
...
_Pick a type _[_Dynamic, Pattern, Primordial, or Questing_](../Setting/Avatars.html)_ and characterize your avatar a bit._

_Avatar 1 costs 0d6, Avatar 2 costs 1d6, 3 costs 2d6, 4 costs 4d6, 5 costs 8d6, 6 costs 16d6_
...
_Pick a _[_Paradigm, at least one Magickal practice, and 7 Instruments_](../Setting/Focus.html)

Focus encompasses both your fundamental beliefs about reality, and the nuts and bolts of how you perform magick.

## Attributes

_Assign d6, d8, d10 to the three Attributes: Physical, Mental, Social._
...
_Pick a Tradition and 3 more._
...
Each distinction can be used as an ordinary d8 trait, but they also have special effects which provide more interesting mechanical effects.

### Special Effects \(sfx\)

_Start with the default sfx. Create a negative sfx to add a positive one._
...
_Spend a Character Die to add Specialties to a Skill. Each Specialty is a d6._
...
_Spend a Character Die to add Specialties to a Sphere. Each specialty is a d6._
...
_A Mage starts with no Backgrounds, but can spend Character Dice to buy them._
