...
When performing focused magick start by defining the Effect of your working and specifically how it flows from your focus. The clearer your statement of narrative intent is the easier the rest of the process will be.

 

Once you have a clear narrative intent for your overall Effect you can break it down into it's discrete component Spheres and determine the level required from each Sphere.

 

It is possible for your Effect to have multiple components of the same Sphere. For example if your magickal attack will have a d6 Fire effect and a d6 electricity effect, you have two different Forces 3 components.

In this case you'd add your Forces trait only once, but reality will get 2d8 for the two Forces 3 components.
...
-   Spheres
    ...
    -   Include the dice from all the Spheres involved in the effect, especially if they are d4
